						...
						<article id="post-0" class="post error404 not-found">
							<header class="entry-header">
								<h1 class="entry-title">
									...
									<?php else: ?>
									<?php _e( 'Oops! That page cannot be found.', 'business-lite' ); ?></h1>
								<?php endif; ?>
							</header>
							...
							<div class="entry-content">
								...
								<?php else: ?>
									<p><?php _e( 'It looks like nothing was found at this location. Maybe try searching for it?', 'business-lite' ); ?></p>
								<?php endif; ?>
								<?php get_search_form(); ?>
