	...
	if ( !function_exists( 'mmm_menu_options_array' ) ) {
		function mmm_menu_options_array(){
			...
			if ( isset( $mmm_menu_options_array ) && $mmm_menu_options_array !== false ) {
				...
				/* Submenu types */
				$submenu_types = array(
					__( 'Standard Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'default_dropdown',
					__( 'Multicolumn Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'multicolumn_dropdown',
					__( 'Grid Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'grid_dropdown',
					__( 'Posts Grid Dropdown', $mega_main_menu->constant[ 'MM_TEXTDOMAIN_ADMIN' ] ) => 'post_type_dropdown',
				);
