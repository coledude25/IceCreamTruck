			...
			foreach ( get_nav_menu_locations() as $key => $value ){
				...
				$skins_options = array_merge( 
					$skins_options, array(
						...
						array(
							'name' => __( 'Font of the First Level Items', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						...
						array(
							'name' => __( 'Icons in the first level items', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
						...
						array(
							'name' => __( 'Icons of the dropdown menu items', $constants[ 'MM_TEXTDOMAIN_ADMIN' ] ),
