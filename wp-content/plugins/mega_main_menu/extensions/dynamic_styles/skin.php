...
{
	' . mm_common::css_gradient( $mega_main_menu->saved_options[ $location_name . '_menu_bg_gradient' ] ) . '
}
#mega_main_menu' . $location_class . ' > .menu_holder > .mmm_fullwidth_container
{
	' . mm_common::css_bg_image( $mega_main_menu->saved_options[ $location_name . '_menu_bg_image' ] ) . '	
}
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > .nav_logo > .mobile_toggle > .mobile_button,
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li > .item_link,
...
{
	' . mm_common::css_font( $mega_main_menu->saved_options[ $location_name . '_menu_first_level_link_font'] ) . '
}
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li > .item_link > i
{
	' . mm_common::css_font( $mega_main_menu->saved_options[ $location_name . '_menu_first_level_icon_font'] ) . '
}
...
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li > .item_link
{
	' . mm_common::css_gradient( $mega_main_menu->saved_options[ $location_name . '_menu_first_level_link_bg'] ) . '
}
...
{
	' . mm_common::css_gradient( $mega_main_menu->saved_options[ $location_name . '_menu_first_level_link_bg_hover'] ) . '
}
...
{
	' . mm_common::css_gradient( $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_wrapper_gradient'] ) . '
}
#mega_main_menu' . $location_class . ' ul > li.default_dropdown .mega_dropdown ul.mega_dropdown > li:first-child > .item_link:after
{
	background-color: ' . $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_wrapper_gradient']['color1'] . '
}
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li .mega_dropdown *
{
	color: ' . $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_plain_text_color'] . ';
}
...
{
	' . mm_common::css_font( $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_link_font'] ) . '
}
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul li .mega_dropdown > li > .item_link.with_icon
{
	...
	mix-height: ' . $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_icon_font']['font_size'] . 'px;
}
#mega_main_menu' . $location_class . ' ul li .mega_dropdown > li > .item_link > i
{
...
#mega_main_menu' . $location_class . ' ul li .mega_dropdown > li > .item_link.with_icon > span
{
	margin-left: ' . ( $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_icon_font']['font_size'] + 8 ) . 'px;
}
#mega_main_menu' . $location_class . '.language_direction-rtl ul li .mega_dropdown > li > .item_link.with_icon > span
{
...
{
	' . mm_common::css_gradient( $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_link_bg'] ) . '
...
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li .mega_dropdown .item_link *,
...
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li .mega_dropdown .item_link:hover,
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li .mega_dropdown .item_link:focus,
...
{
	' . mm_common::css_gradient( $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_link_bg_hover'] ) . '
...
#mega_main_menu' . $location_class . ' ul li.grid_dropdown .mega_dropdown > li.current-menu-item > .item_link *,
#mega_main_menu' . $location_class . ' ul li.post_type_dropdown .mega_dropdown > li > .processed_image:hover > .cover > a > i
{
	color: ' . $mega_main_menu->saved_options[ $location_name . '_menu_dropdown_link_color_hover'] . ';
}
#mega_main_menu' . $location_class . '.primary_style-buttons > .menu_holder > .menu_inner > ul > li > .item_link,
...
/*
#mega_main_menu' . $location_class . '.direction-horizontal.first-lvl-align-left.no-logo.no-search.no-woo_cart > .menu_holder > .menu_inner > ul > li:first-child > .item_link,
#mega_main_menu' . $location_class . '.direction-horizontal.first-lvl-align-left.no-logo.include-search > .menu_holder > .menu_inner > ul > li:nth-child(200n+2) > .item_link,
#mega_main_menu' . $location_class . '.direction-horizontal.first-lvl-align-left.no-logo.include-woo_cart > .menu_holder > .menu_inner > ul > li:nth-child(200n+2) > .item_link,
#mega_main_menu' . $location_class . '.direction-horizontal.first-lvl-align-left.no-logo.include-search.include-woo_cart > .menu_holder > .menu_inner > ul > li:nth-child(200n+3) > .item_link,
#mega_main_menu' . $location_class . '.direction-horizontal.first-lvl-align-left.no-logo.include-search.include-woo_cart.include-buddypress > .menu_holder > .menu_inner > ul > li:nth-child(200n+4) > .item_link,
*/
...
{
	border-radius: ' . $mega_main_menu->saved_options[ $location_name . '_corners_rounding'] . 'px ' . $mega_main_menu->saved_options[ $location_name . '_corners_rounding'] . 'px 0px 0px;
}
