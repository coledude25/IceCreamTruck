...
//WisdLabs Sidebar
if(!function_exists('pwe_create_wisdm_sidebar')) :
function pwe_create_wisdm_sidebar($plugin_name, $wdm_plugin_slug)
{
...
<?php     
   if(isset($_POST["cde-submit"]))
   {
      ...
      add_filter( 'wp_mail_from', 'wdm_mail_from' );
      add_filter( 'wp_mail_from_name', 'wdm_mail_from_name' );
      add_filter('wp_mail_content_type','cde_set_contenttype');
	...
	<?php
      ...
      remove_filter( 'wp_mail_from', 'wdm_mail_from' );
      remove_filter( 'wp_mail_from_name', 'wdm_mail_from_name' );
      remove_filter('wp_mail_content_type','cde_set_contenttype');
   }
}
endif;

if(!function_exists('cde_set_contenttype')) :
function cde_set_contenttype()
{
   return 'text/html';
}
 endif;

if(!function_exists('wdm_mail_from')) :
function wdm_mail_from($email)
{
...
if(!function_exists('wdm_mail_from_name')) :
function wdm_mail_from_name($name)
{
